...
$pagename="Vegetable"; //create and populate variable called $pagename
...
$SQL="SELECT proId, prodName, prodPicNameSmall,prodDescripShort,prodPrice from Product Where prodType='v' And ProdQuantity >0 ";
